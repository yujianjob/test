...
namespace LazyAtHome.Library.Pay.MobileEmbed.WXPayment
{
    ...
    public class TenpayUtil
    {
        ...
        public static string partner = "10016804";                   //商户号
        public static string key = "ASCAmEwg5nth6DgJdAgEAAoGBAKIfHcE";  //密钥
        public static string appid = "wx9ab0f092bce2810f";//appid

...
namespace LazyAtHome.WCF.Express.Contract.DataContract
{
    ...
    [DataContract]
    [Serializable]
    public class Exp_Preson_PaymentLogDC : EntityBase
    {
        #region Model
        /// <summary>
        /// 
        ...
        /// <summary>
        /// 根据Reader生成Exp_Preson_PaymentLogDC对象
        /// </summary>
        /// <param name="reader">数据集</param>
        public static Exp_Preson_PaymentLogDC GetEntity(IDataReader reader)
        {
            Exp_Preson_PaymentLogDC entity = null;

            entity = new Exp_Preson_PaymentLogDC();

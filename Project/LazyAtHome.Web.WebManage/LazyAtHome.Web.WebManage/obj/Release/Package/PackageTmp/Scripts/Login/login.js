...
$(function () {
    ...
    $("#IbtnEnter").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: $("#LoginUrl").val(),
            data: { iLoginName: $("#username").val(), iPassWord: $("#password").val(), iValidateCode: $("#userauthcode").val() },
            dataType: "json",
            success: function (data) {
                ...
                if (data.success) {
                    ...
                    $.cookie('ldjusername', $("#username").val(), { expires: 365 });

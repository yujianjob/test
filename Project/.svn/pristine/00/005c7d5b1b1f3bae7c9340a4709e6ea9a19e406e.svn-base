...
namespace LazyAtHome.Web.WeiXin3.App_Code.Proxy
{
    public class UserProxycs
    {
        ...
        public static ReturnEntity<bool> wx_User_Weixin_Reg(string iOpenid, string iLoginName, string iPassword, string iEmail)
        {
            var rtn = WCFInvokeHelper<UserClient>.Invoke<ReturnEntity<bool>>(c => c.Proxy.wx_User_Weixin_Reg(iOpenid, iLoginName, iPassword, iEmail));
            return rtn;
        }
        ...
        public static ReturnEntity<User_WeixinDC> wx_User_Weixin_Login(string iOpenid, string iLoginName, string iPassword)
        {
            var rtn = WCFInvokeHelper<UserClient>.Invoke<ReturnEntity<User_WeixinDC>>(c => c.Proxy.wx_User_Weixin_Login(iOpenid, iLoginName, iPassword));
            return rtn;
        }

        public static ReturnEntity<User_WeixinDC> wx_User_Weixin_Login(string iOpenid, string iMPNo)
        {
            var rtn = WCFInvokeHelper<UserClient>.Invoke<ReturnEntity<User_WeixinDC>>(c => c.Proxy.wx_User_Weixin_Login(iOpenid, iMPNo));
            return rtn;
        }
        ...
        public static ReturnEntity<User_WeixinDC> wx_User_Weixin_Bind_Part(string iOpenid, string iMPNo, string iNickName, int iSite, string iIPAddress, string iInviteCode = null)
        {
            var rtn = WCFInvokeHelper<UserClient>.Invoke<ReturnEntity<User_WeixinDC>>(c => c.Proxy.wx_User_Weixin_Bind_Part(iOpenid, iMPNo, iNickName, iSite, iIPAddress, iInviteCode));
            return rtn;
        }

        public static ReturnEntity<bool> User_Coupon_Bind_Check(Guid iUserID, string iCouponCode)
        {
            var rtn = WCFInvokeHelper<UserClient>.Invoke<ReturnEntity<bool>>(c => c.Proxy.User_Coupon_Bind_Check(iUserID, iCouponCode));
            return rtn;
        }
    }
}
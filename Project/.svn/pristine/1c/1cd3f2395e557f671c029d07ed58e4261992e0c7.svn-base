...
namespace LazyAtHome.Library.Partners.SFExpress.Entity
{
    ...
    [DataContract]
    [Serializable]
    public class OrderServiceResponse : EntityBase
    {
        /// <summary>
        /// 订单号 
        /// </summary>
        ...
        public OrderServiceResponse(string xml)
            : base("OrderService", xml)
        {
        ...
        public override bool AnalyzeBody()
        {
            ...
            this.origincode = xmlResponse.Attributes["origincode"].Value + " SM";
            this.destcode = xmlResponse.Attributes["destcode"].Value + " SM";

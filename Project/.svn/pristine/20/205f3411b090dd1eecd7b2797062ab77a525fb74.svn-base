...
{
    public partial class frmStockOutNotifyItemBad : Form
    {
        private Business.WashOrder o_business = null;

        public frmStockOutNotifyItemBad()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!o_business.OrderOutFactory_FailNotify_ItemBad(this.txtOrderNumber.Text, this.cboNotifyType.Text + "：" + this.txtRemark.Text, Common.ConstConfig.currOperator.ID))
            {

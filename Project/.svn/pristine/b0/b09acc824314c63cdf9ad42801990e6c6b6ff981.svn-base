...
namespace LazyAtHome.Web.WeiXin
{
    public class CustomMessageHandler : MessageHandler<MessageContext>
    {
        ...
        public override IResponseMessageBase DefaultResponseMessage(IRequestMessageBase requestMessage)
        {
            ...
            article.PicUrl = CustomerConfig.BaseUrl + "/Images/welcome.jpg";
            article.Url = CustomerConfig.BaseUrl + "/weixin/welcome";
        ...
        {
            App_Code.Proxy.UserProxy.User_WeixinAttention_ADD(requestMessage.FromUserName, requestMessage.CreateTime, requestMessage.EventKey);
            return base.OnEvent_SubscribeRequest(requestMessage);
        }

        public override IResponseMessageBase OnEvent_UnsubscribeRequest(RequestMessageEvent_Unsubscribe requestMessage)
        {
            App_Code.Proxy.UserProxy.User_WeixinAttention_Remove(requestMessage.FromUserName);

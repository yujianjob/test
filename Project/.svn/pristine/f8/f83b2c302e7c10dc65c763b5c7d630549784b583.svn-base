...
namespace LazyAtHome.Library.Pay.Common.Alipay
{
    ...
    {
        //支付宝网关地址
        public const string GATEWAY_WAP = "http://wappaygw.alipay.com/service/rest.htm?";
        public const string GATEWAY_PC = "https://mapi.alipay.com/gateway.do?";
        #region 字段
        //商户的MD5私钥
        ...
        public static string BuildRequest(string GATEWAY_NEW, SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            //待请求参数数组
        ...
        public static string BuildRequest(string GATEWAY_NEW, SortedDictionary<string, string> sParaTemp)
        {
        ...
        /// <returns>支付宝处理结果</returns>
        public static string BuildRequest(string GATEWAY_NEW, SortedDictionary<string, string> sParaTemp, string strMethod, string fileName, byte[] data, string contentType, int lengthFile)
        {

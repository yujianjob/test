 ...
 * generated in the com.landaojia.washclothes.userappserver.service.sms.yimei.ws package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.landaojia.washclothes.userappserver.service.sms.yimei.ws
     * 
     */

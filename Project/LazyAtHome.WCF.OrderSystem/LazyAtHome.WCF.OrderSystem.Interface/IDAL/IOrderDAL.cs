...
namespace LazyAtHome.WCF.OrderSystem.Interface.IDAL
{
    public interface IOrderDAL
    {
        ...
        DataTable Order_PayRecord_Select(string iOrderNumber, int? payType, int? Status);

        bool Order_PayRecord_Update(string iOrderNumber, int payType, int Status);

        bool Order_PayAmount_Update(int iOrderID, decimal PayAmount);
    }
}

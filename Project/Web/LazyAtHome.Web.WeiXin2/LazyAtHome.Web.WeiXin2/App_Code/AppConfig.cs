...
namespace LazyAtHome.Web.WeiXin2
{
    public class AppConfig
    {
        ...
        internal const string Alipay_Notify_URL = "http://wx.landaojia.com/Cart/AlipayNotify";
        internal const string Alipay_Return_URL = "http://wx.landaojia.com/Cart/AlipayReturn";
        ...
        internal const string WX_Notify_URL = "http://wx.landaojia.com/Cart/WxPayNotify";
        ...
        internal const string WeiXin_BaseUrl = "http://wx.landaojia.com";
        internal const string WeiXin_AuthorizeRedirectUrl = "http://wx.landaojia.com/weixin/OAuthResponse";

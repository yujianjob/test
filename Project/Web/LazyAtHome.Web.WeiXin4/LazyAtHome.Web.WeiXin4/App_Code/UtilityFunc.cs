...
namespace LazyAtHome.Web.WeiXin4.App_Code
{
    public class UtilityFunc
    {
        ...
        public static T GetPostResponse<T>(string url, Dictionary<string, string> dic)
        {
            return Post.GetResult<T>(Senparc.Weixin.HttpUtility.RequestUtility.HttpPost(url, null, dic));   
        }
    }
}

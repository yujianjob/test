...
namespace LazyAtHome.Web.WashSite.App_Code.Proxy
{
    public class UserProxycs
    {
        ...
        public static ReturnEntity<User_ConsigneeAddressDC> Select_UserAddressEntity(int id)
        {
        ...
        public static ReturnEntity<int> Add_UserAddress(User_ConsigneeAddressDC addressItem)
        {
            var rtn = WCFInvokeHelper<UserClient>.Invoke<ReturnEntity<int>>(c => c.Proxy.User_ConsigneeAddress_ADD(addressItem));
            return rtn;
        }

        public static ReturnEntity<bool> Delete_UserAddress(int id)
        {
